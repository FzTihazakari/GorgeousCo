...
<html class="no-js" lang="en">
  <head>
    ...
    <title> Local Products || GORGEOUS Skin Specialist</title>
  ...
  <section class="top-bar-section">
    ...
    <ul class="right">
      ...
      <li><a href="products.php" class="dropbtn">Products</a></li>
...
<br><br>
    ...
    <img style="width: 200px;" src="images/dom-logo.png"  alt="Small Image" class="small-image"><br>
    ...
    <div class="row" style="margin-top:10px;">
      ...
      <div class="product-container">
        <?php
          ...
          $result = $mysqli->query('SELECT * FROM productsL');
          if($result === FALSE){
            die(mysql_error());
          }
          ...
          if ($i % 4 === 0 && $i !== 0) {
            $separatorImages = ['images/skintific-logo.png', 'images/theraw-logo.png', 'images/zarzou-logo.png', 'images/kayman-logo.png'];
